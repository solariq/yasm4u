...
public class MRProcTest {
  ...
  public void testResolve() {
    MREnv env = new LocalMREnv();
    MRWhiteboard wb = new MRWhiteboardImpl(env, "proc", "none");
    wb.set("xxx", "yyy");
    final String resolveString = wb.resolve("{var:xxx}");
    final MRTable resolveTable = wb.resolve("mr://xxx");
