...
public class MROutput2Writer extends MROutputBase {
  private static final Pair<Integer, CharSequence> STOP = new Pair<>(-1, "");
  private static Logger LOG = Logger.getLogger(MROutputBase.class);
  private final Thread outputThread;
  private final ArrayBlockingQueue<Pair<Integer, CharSequence>> queue = new ArrayBlockingQueue<>(MRReduce.MAX_REDUCE_SIZE);
