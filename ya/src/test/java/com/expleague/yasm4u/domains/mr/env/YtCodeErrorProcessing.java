...
public class YtCodeErrorProcessing {
  ...
  private static class StrictlyIgnoringProcessor implements Consumer<CharSequence> {
    @Override
  ...
  private static class ParsingOnlyProcessor extends YtMREnv.YtResponseProcessor {
    ...
    public ParsingOnlyProcessor(Consumer<CharSequence> processor) {
      super(processor);
    }
  ...
  private static class ParsingOnlyMRProcessor extends YtMREnv.YtMRResponseProcessor{
    ...
    public ParsingOnlyMRProcessor(Consumer<CharSequence> processor) {
      super(processor);
    }
  ...
  public static Consumer<CharSequence> STRICTLY_IGNORING_PROCESSOR = new StrictlyIgnoringProcessor();
  public static Consumer<CharSequence> IGNORING_PROCESSOR = x -> {};
  @Test
