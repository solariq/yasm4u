...
public class MRPath implements Serializable, Ref<MRPath, MREnv> {
  ...
  public static MRPath create(String source) {
    ...
    boolean sorted = false;
    {
      ...
      while (nextAttrStart > 0) {
        ...
        CharSeqTools.split(
                CharSeqAdapter.create(source, nextAttrStart, attrsStartNext > 0 ? attrsStartNext : source.length()), '=', key2value);
  ...
  public boolean equals(Object o) {
    ...
    return sorted == mrPath.sorted && mount == mrPath.mount && path.equals(mrPath.path);
  }
